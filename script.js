      ...
      contactForm.addEventListener('submit', function(e) {
        ...
        requiredFields.forEach(function(field) {
          ...
          if (field.type === 'tel' && !validatePhone(value)) {
            showError(field, field.getAttribute('data-error-phone') || 'Please enter a valid phone number');
            isValid = false;
          }
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'e689fc7e-1113-4a27-9398-b0e1c0f7aae3',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'e689fc7e-1113-4a27-9398-b0e1c0f7aae3';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'e689fc7e-1113-4a27-9398-b0e1c0f7aae3';
